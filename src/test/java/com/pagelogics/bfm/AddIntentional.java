...
public class AddIntentional extends Baseclass{
...
//			click(new DailyTaskLocators().getAddMontessori());
			click(new DailyTaskLocators().getAddIntentional());
...
//			click(new DailyTaskLocators().getSlctStaffBtn());
			...
			click(new DailyTaskLocators().getSltChildName());
			click(new DailyTaskLocators().getSveChild());
			Thread.sleep(1000);
			new DailyTaskLocators().getActTitle().sendKeys("Testing"+dt1+"");
//			Thread.sleep(1000);
			new DailyTaskLocators().getAimDirect().sendKeys("TestingQA"+dt1+"");
//			Thread.sleep(1000);
			new DailyTaskLocators().getAimInDirect().sendKeys("TestingQA1"+dt1+"");
//			Thread.sleep(1000);
			new DailyTaskLocators().getVocabulary().sendKeys("TestingQA2"+dt1+"");
			Thread.sleep(1000);
...
//				}
			...
			new DailyTaskLocators().getIntentComment().sendKeys("Testing"+dt1+"");
			new DailyTaskLocators().getIntentInternalNote().sendKeys("Testing"+dt1+"");
