...
public class DailyTaskLogic extends Baseclass{
...
//			click(new DailyTaskLocators().getSlctStaffBtn());
			...
			Thread.sleep(1000);
			click(new DailyTaskLocators().getSlctDayandNight());
			Thread.sleep(1000);
...
//				Toolkit.getDefaultToolkit().getSystemClipboard().setContents(st3,null);
			...
			try {
				rbt1 = new Robot();
				rbt1.delay(2000);
				StringSelection st1 = new StringSelection("C:\\Users\\TSI\\Downloads\\Sample Images\\For Automation\\Sample-jpg-image-15mb - Copy (2).jpeg");
			...
			try {
				rbt2 = new Robot();
				rbt2.delay(2000);
				StringSelection st2 = new StringSelection("C:\\Users\\TSI\\Downloads\\Sample Images\\For Automation\\Sample-jpg-image-15mb - Copy (2).jpeg");
				Toolkit.getDefaultToolkit().getSystemClipboard().setContents(st2,null);
...
//				}
			...
			new DailyTaskLocators().getComment().sendKeys("Testing"+dt1+"");
