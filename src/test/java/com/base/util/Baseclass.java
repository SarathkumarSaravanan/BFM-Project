...
public class Baseclass {
	...
	public static void teststatus(String status, String description) {
	...
	public static String getoption(WebElement element)
	{
		String ele="";
	sel=new Select(element);
	...
	public static void jsData(WebElement element,String value)
	{
	...
	public static void explicitWaite(int time, WebElement element)
	{
	WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(time));
	wait.until(ExpectedConditions.visibilityOf(element));
	}
	public static String readexcel(String path,String sheetname,int row, int col) throws IOException
	{
	FileInputStream fis= new FileInputStream(path);	
	XSSFWorkbook workbook= new XSSFWorkbook(fis);
	XSSFSheet sheet = workbook.getSheet(sheetname);
	XSSFRow rowval = sheet.getRow(row);
	XSSFCell cont=rowval.getCell(col);
	String dt=cont.getStringCellValue();
	return dt;
	}
	...
	public static void swith(String windowname)
	{
